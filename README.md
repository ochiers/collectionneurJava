...
- voir évoluer les items d'autres utilisateurs

Les items à collectionner et les fonctionnalités développées devront répondre à la problématique du sujet national ou correspondre à une des fonctionnalités requises dans le cadre du sujet national.

Un utilisateur authentifié, appelé collectionneur, aura, de plus, la possibilité de suivre certains groupes et de savoir quels items ont été ajoutés, modifiés, ou supprimés de ce groupe.
Elements attendus
